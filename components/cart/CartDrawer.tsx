        ...
        {isDrawerOpen && (
          <Drawer.Portal keepMounted>
            ...
            <Drawer.Viewport className="fixed inset-0 z-50 flex justify-end">
              <Drawer.Popup
                className="flex h-full w-full max-w-md flex-col border-l border-border bg-popover text-popover-foreground shadow-xl outline-none"
                render={
                  <motion.div
              ...
              >
                <div className="flex items-center justify-between border-b border-border px-gutter py-4">
                  <Drawer.Title className="flex items-center gap-2 font-heading text-lg font-semibold">
