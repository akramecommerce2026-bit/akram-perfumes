  ...
  return (
    ...
    >
      <header className="mb-5 flex items-center gap-3">
        <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-[color-mix(in_oklab,var(--accent)_16%,transparent)] font-heading text-sm font-semibold text-accent-foreground">
          {step}
        </span>
        <div>
